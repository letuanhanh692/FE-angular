...
//   }
//   goHome() {
//     this.router.navigate(['/user/searchtrip']); // Điều hướng về trang chủ
//   }
// }
...
@Component({
  selector: 'app-confirmation',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule, RouterModule], // ✅ Thêm RouterModule
  templateUrl: './confirmation.component.html',
  styleUrls: ['./confirmation.component.css']
})
export class ConfirmationComponent implements OnInit {
  ...
  constructor(
    ...
    private route: ActivatedRoute, // ✅ Thêm ActivatedRoute để lấy query params
  ...
  ngOnInit(): void {
    ...
    const navigation = this.router.getCurrentNavigation();
    this.bookingData = navigation?.extras.state || history.state;
  ...
  // ✅ Điều hướng về trang tìm kiếm chuyến đi
  goHome(): void {
